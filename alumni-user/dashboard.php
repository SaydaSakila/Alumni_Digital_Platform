                            ...
                            while($post = $posts->fetch_assoc()) {
                                ...
                                {?>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                       <a href="blog.php?id=<?php echo $post['id']; ?>" class="btn btn-primary btn-sm"><i class="fas fa-eye"></i></a>
                                            <a href="edit-post.php?edit=<?php echo $post['id']; ?>" class="btn btn-success btn-sm"><i class="fas fa-edit"></i></a>
                                            <a onclick="return confirm('Do You Want to delete this Blog?')" href="delete-post.php?delete=<?php echo $post['id']; ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a>
                                       </td>
                                    </tr>
                                <?php
                                }
