                ...
                <div class="card" >
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="uposts.php" class="btn btn-success">Blog List</a>
                        </div>
                    </div>
                    <div class="card-body" >
                        ...
                        <div class="col-md-12 ">
                            ...
                            ?>
                            <form action="submit/upost-add-submit.php" method="POST">
                                ...
                                <div class="form-group">
                                    <button class="btn btn-success btn-lg btn-block" type="submit" name="u-post_submit">Save Blog</button>
                                </div>
                                <div class="form-group ">
