<?php
    $page_title = 'Update Batch Information';
    // include header file
            ...
            <input type="hidden" name="id" value='<?php  echo $data['id']; ?>' ></input>
                <div class="card-body">
                   ...
                   <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" value='<?php  echo $data['name']; ?>' placeholder="Update Batch Name">
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-secondary btn-lg btn-block" name="update_batch">UPDATE</button>
                </div>
            </form>
        </div>
    </div>
