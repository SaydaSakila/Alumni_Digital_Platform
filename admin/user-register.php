    ...
    <div class="col-md-6 offset-md-3">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Create New User - Alumni</h3>
            </div>
            <form action="submit/register-submit.php" method="POST">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="_name"  class="form-control" placeholder="Enter Name" value="<?php 
                                    if(isset($data['name'])) 
                                    {
                                        echo $data['name'];
                                    }
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" id="_email" class="form-control" placeholder="Enter Email" value="<?php 
                                    if(isset($data['email'])) 
                                    {
                                        echo $data['email'];
                                    }
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="username" id="_username" class="form-control" placeholder="Enter Username" value="<?php 
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="phone" id="_phone" class="form-control" placeholder="Enter Phone Number" value="<?php 
                                    if(isset($data['phone'])) 
                                    {
                                        echo $data['phone'];
                                    }
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="address" id="_address" class="form-control" placeholder="Enter Address" value="<?php 
